...
using System.Text;
using FJSP_BASIC_BRICK.Constraint;
...
namespace FJSP_BASIC_BRICK
{
    internal class Program
    {
        ...
        static void BuildModelB(Dataload data, OptEngine engine)
        {
            ...
            engine.BuildCVs<VariableX_Makespan>();

            new ObjectiveFunction(engine).Build();
            ...
            new Constraint_MakespanDef(data.LOT, data.OPERATION, engine).Build();
            new Constraint_MakespanWindow(data.MakespanFloor, data.MakespanDeadline, engine).Build();
            new Constraint_MakespanTargetSoft(data.SoftMakespanTarget, data.MakespanPenalty, engine).Build();
        }
        ...
        static void BuildModelC(Dataload data, OptEngine engine)
        {
            ...
            new Constraint_MakespanInfeasibleCap(data.InfeasibleMakespanCap, engine).Build();
        }
